...
data class PredictPointsResponse(val predictPointsTableData: List<PredictPointsItemArr>?, val teamBatting: String, val status: String, val statusColor: String, val showStatus: Boolean, val error: ErrorModel?) {
